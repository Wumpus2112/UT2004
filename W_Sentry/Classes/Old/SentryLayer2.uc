...
//
//-----------------------------------------------------------
class SentryLayer2 extends Weapon;
...
simulated function AddSentry(Sentry newTurret){
...
defaultproperties
{
    ...
    FireModeClass(0)=SentryThrowFire
    FireModeClass(1)=SentryThrowFire
