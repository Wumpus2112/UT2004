...
//
//-----------------------------------------------------------
class SentryXLayer extends Weapon;
...
simulated function AddSentry(SentryX newTurret){
...
//    DrawType=DT_Mesh
    ...
    BobDamping=2.2
    PickupClass=class'W_Sentry.SentryXPickup'
