class ControllerSentryBase extends AIController;
...
auto state Searching
{
	...
	{
		    log("Base-Searching:event SeePlayer: "@SeenPlayer.Class);
...
state WaitForTarget
{
	event SeePlayer(Pawn SeenPlayer)
	{
	    log("Base-WaitForTarget:event SeePlayer: "@SeenPlayer.Class);
	...
	function BeginState()
	{
	    log("WaitForTarget:BeginState: "@Pawn.Class);
