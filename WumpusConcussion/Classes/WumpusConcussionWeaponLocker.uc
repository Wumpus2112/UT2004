class WumpusConcussionWeaponLocker extends Pickup;
...
simulated function PostNetBeginPlay()
{
    ...
    for ( i=0; i<Weapons.Length; i++ ){
        Weapons[i].ExtraAmmo = 25;
        Weapons[i].WeaponClass = class<Weapon>(DynamicLoadObject("WumpusConcussion.WumpusConcussionRifle",class'class'));
    }
