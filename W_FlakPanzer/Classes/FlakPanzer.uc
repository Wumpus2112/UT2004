...
//
//-----------------------------------------------------------
class FlakPanzer extends ONSTreadCraft;
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'W_FlakPanzer.FlakPanzerWeapon',WeaponBone="TankCannonWeapon")
//     PassengerWeapons(0)=(WeaponPawnClass=Class'Onslaught.ONSTankSecondaryTurretPawn',WeaponBone="MachineGunTurret")
     ...
     VehiclePositionString="in a Flak Panzer"
     VehicleNameString="Flak Panzer"
