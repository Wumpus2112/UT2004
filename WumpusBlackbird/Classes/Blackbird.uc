...
//
//-----------------------------------------------------------
class Blackbird extends ONSChopperCraft
    placeable;
...
//=============================================================================
/*
simulated function UpdateRocketAccelerationXX(float DeltaTime, float YawChange, float PitchChange)
{
    local vector    X,Y,Z;
...
defaultproperties
{
     ...
     /*
     UprightStiffness=500.0 //500.000000
     UprightDamping=300.0 //300.000000
     MaxThrustForce=200.0 //100.000000
     LongDamping=0.0 //0.050000
     MaxStrafeForce=0.0 //80.000000
     LatDamping=0.0 //0.050000
     MaxRiseForce=1.0 //50.000000
     UpDamping=0.050000
     TurnTorqueFactor=1.0 //600.000000
     TurnTorqueMax=1.0 //200.000000
     TurnDamping=1.0 //50.000000
     MaxYawRate=1.0 //1.500000
     PitchTorqueFactor=1.0 //200.000000
     PitchTorqueMax=1.0 //35.000000
     PitchDamping=1.0 //20.000000
     RollTorqueTurnFactor=1.0 //450.000000
     RollTorqueStrafeFactor=1.0 //50.000000
     RollTorqueMax=1.0 //50.000000
     RollDamping=1.0 //30.000000
     StopThreshold=1.0 //100.000000
     MaxRandForce=0.0 //3.000000
     RandForceInterval=0.0 //0.750000
     */
...
//     Physics=PHYS_Karma
     ...
     VehiclePositionString="in the Blackbird"
     VehicleNameString="Blackbird"
}
