class DarkNewIonEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=55,G=28,R=55))
     ...
     End Object
     Emitters(0)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=60,G=60,R=60,A=10))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=80,G=80,R=80,A=25))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=150
     ...
     End Object
     Emitters(1)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=36,G=37,R=55))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=50
         StartLocationShape=PTLS_Sphere
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(2)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=80,G=80,R=80,A=55))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=55,G=55,R=55,A=55))
         ColorScale(3)=(RelativeTime=1.000000)
     ...
     End Object
     Emitters(3)=MeshEmitter'W_DarkMatter.DarkNewIonEffect.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=80,G=5,R=80))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=80,G=5,R=40))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=2
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(4)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=55,G=80))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=55,G=4,R=20))
     ...
     End Object
     Emitters(5)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         RespawnDeadParticles=False
         AutomaticInitialSpawning=False
         ColorScale(0)=(Color=(B=42,G=55))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=9,G=5,R=94))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(6)=SpriteEmitter'W_DarkMatter.DarkNewIonEffect.SpriteEmitter6'
     ...
     End Object
     Emitters(7)=MeshEmitter'W_DarkMatter.DarkNewIonEffect.MeshEmitter2'
