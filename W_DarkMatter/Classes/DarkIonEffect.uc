class DarkIonEffect extends Actor;

#exec OBJ LOAD FILE=XEffectMat.utx

var Vector HitLocation, HitNormal;
var DarkIonShaft IonShaft;
var DarkIonLightBeam IonLightBeam;
var DarkIonCore IonCore;
var float StartTime;
var() float DropTime;
...
{
    IonCore = Spawn(class'DarkIonCore',,, Location, Rotation);
    IonShaft = Spawn(class'DarkIonShaft',,, Location, Rotation);
    IonShaft.mSpawnVecA = Location;
    IonLightBeam = Spawn(class'DarkIonLightBeam',,, Location, Rotation);
...
state Drop
{
    ...
    simulated function Timer()
    {
       ...
       A = Spawn(class'DarkNewIonEffect',,, HitLocation+Vect(0,0,100), Rot(0,16384,0));
