class EMPRedeemerGuidedFire extends EMPRedeemerFire;

function Projectile SpawnProjectile(Vector Start, Rotator Dir)
{
//    local RedeemerWarhead Warhead;
    local EMPRedeemerWarhead Warhead;
	local PlayerController Possessor;

//    Warhead = Weapon.Spawn(class'XWeapons.RedeemerWarhead', Instigator,, Start, Dir);
    Warhead = Weapon.Spawn(class'W_EMPRedeemer.EMPRedeemerWarhead', Instigator,, Start, Dir);
    if (Warhead == None)
//		Warhead = Weapon.Spawn(class'XWeapons.RedeemerWarhead', Instigator,, Instigator.Location, Dir);
		Warhead = Weapon.Spawn(class'W_EMPRedeemer.EMPRedeemerWarhead', Instigator,, Instigator.Location, Dir);
    if (Warhead != None)
    {
