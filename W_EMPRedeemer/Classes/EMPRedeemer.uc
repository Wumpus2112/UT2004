class EMPRedeemer extends Weapon
    config(user);
...
defaultproperties
{
     FireModeClass(0)=Class'W_EMPRedeemer.EMPRedeemerFire'
     FireModeClass(1)=Class'W_EMPRedeemer.EMPRedeemerGuidedFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=0
     GroupOffset=1
     PickupClass=Class'W_EMPRedeemer.EMPRedeemerPickup'
