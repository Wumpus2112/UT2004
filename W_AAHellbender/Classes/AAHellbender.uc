...
//
//-----------------------------------------------------------
class AAHellbender extends ONSWheeledCraft;
...
defaultproperties
{
     ...
     PassengerWeapons(0)=(WeaponPawnClass=Class'Onslaught.ONSTankSecondaryTurretPawn',WeaponBone="Dummy01")
     PassengerWeapons(1)=(WeaponPawnClass=Class'W_AAHellbender.AAHellbenderRearWeaponPawn',WeaponBone="Dummy02")
