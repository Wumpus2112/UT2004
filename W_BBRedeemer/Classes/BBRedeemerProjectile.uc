...
// Dumb Fire rocket.
//=============================================================================
class BBRedeemerProjectile extends Projectile;
...
var int i;
var BBRedeemerBombletContainer NewContainer;
var int magnitude;
var vector mDirection;
...
defaultproperties
{
     ...
     LifeSpan=20.000000
     DrawScale=0.500000
     Skins(0)=Texture'W_ReedemerTex.Skins.RDMR_Missile_BLK'
     AmbientGlow=96
     bUnlit=False
     SoundVolume=255
