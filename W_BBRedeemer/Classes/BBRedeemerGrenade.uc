...
// Grenade.
//=============================================================================
class BBRedeemerGrenade extends Projectile;

var float ExplodeMinTimer,ExplodeRndTimer;
...
replication
{
    reliable if (Role==ROLE_Authority)
        ExplodeMinTimer,ExplodeRndTimer;
}
...
simulated function PostNetBeginPlay()
{
    ...
    {
        SetTimer(ExplodeMinTimer+FRand()*ExplodeRndTimer, false);
        bTimerSet = true;
    }
}
...
defaultproperties
{
     ExplodeMinTimer=2.000000
     ExplodeRndTimer=4.000000
