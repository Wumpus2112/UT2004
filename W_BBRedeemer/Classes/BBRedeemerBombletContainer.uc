...
// flakshell
//=============================================================================
class BBRedeemerBombletContainer extends Projectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    local rotator rot;
    local int i;
    local BBRedeemerBomblet NewChunk;
    local int magnitude;
	...
	if ( Role == ROLE_Authority )
	{
		...
		for (i=0; i<10; i++)
		{
			...
			//NewChunk = Spawn( class 'BBRedeemerBomblet',, '', Start, rot);
			NewChunk = Spawn( class 'BBRedeemerBomblet',, '', Start,rot);
