class WumpusSniperRifle extends Weapon
    config(user);
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'W_Sniper.WumpusSniperFire'
     FireModeClass(1)=Class'W_Sniper.WumpusSniperZoom'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=9
     GroupOffset=1
     PickupClass=Class'W_Sniper.WumpusSniperRiflePickup'
     PlayerViewOffset=(X=27.700001,Y=5.300000,Z=-10.600000)
     PlayerViewPivot=(Yaw=16384)
     BobDamping=2.300000
     AttachmentClass=Class'W_Sniper.WumpusSniperAttachment'
     IconMaterial=Texture'HUDContent.Generic.HUD'
     IconCoords=(X1=420,Y1=180,X2=512,Y2=210)
     ItemName="Wumpus Sniper Rifle"
     LightType=LT_Steady
