class WumpusSniperFire extends InstantFire;
...
defaultproperties
{
     HeadShotDamageMult=10.000000
     DamageTypeHeadShot=Class'W_Sniper.DamTypeWumpusSniperHeadShot'
     FireAnims(0)="Fire1"
     FireAnims(1)="Fire2"
     FireAnims(2)="fire3"
     DamageType=Class'W_Sniper.DamTypeWumpusSniperShot'
     DamageMin=20
     DamageMax=20
     TraceRange=30000.000000
     FireSound=SoundGroup'WeaponSounds.SniperRifle.SniperRifleAltFire'
     FireForce="NewSniperShot"
     FireRate=0.330000
     AmmoClass=Class'W_Sniper.WumpusSniperAmmo'
     AmmoPerFire=1
