...
//
//-----------------------------------------------------------
class InterfaceTeamVoterPage extends PopupPageBase;
...
simulated function Timer(){
    local int divBy10Remainder;

    Blink();

    // timer set for .1 secs fire "second" timer each second
    timerCounter++;
    divBy10Remainder = timerCounter%10;
    if(divBy10Remainder == 0){
        TimerEachSecond();
    }

}

simulated function TimerEachSecond(){
    LoadReplicationInfo();
    UpdatePing();
}
...
defaultproperties
{
     ...
     End Object
     sb_RedMain=AltSectionBackground'W_TeamVoter.InterfaceTeamVoterPage.RedInternalFrameImage'
     ...
     End Object
     sb_BlueMain=AltSectionBackground'W_TeamVoter.InterfaceTeamVoterPage.BlueInternalFrameImage'
     ...
     End Object
     sb_GreyMain=AltSectionBackground'W_TeamVoter.InterfaceTeamVoterPage.GreyInternalFrameImage'
     ...
     Begin Object Class=GUIListBox Name=RedTeamList
         ...
         bScaleToParent=True
     End Object
     lb_RedTeam=GUIListBox'W_TeamVoter.InterfaceTeamVoterPage.RedTeamList'
     ...
     Begin Object Class=GUIListBox Name=BlueTeamList
         ...
         bScaleToParent=True
     End Object
     lb_BlueTeam=GUIListBox'W_TeamVoter.InterfaceTeamVoterPage.BlueTeamList'
     ...
     Begin Object Class=GUIListBox Name=GreyTeamList
         ...
         bScaleToParent=True
     End Object
     lb_GreyTeam=GUIListBox'W_TeamVoter.InterfaceTeamVoterPage.GreyTeamList'
     ...
     Begin Object Class=GUIHeader Name=TitleBar
         ...
         bNeverFocus=False
     End Object
     t_WindowTitleX=GUIHeader'W_TeamVoter.InterfaceTeamVoterPage.TitleBar'
     ...
     Begin Object Class=GUIButton Name=SelectButton
         ...
         TabOrder=100
         bBoundToParent=True
         OnClick=InterfaceTeamVoterPage.InternalSelectButtonClick
         OnKeyEvent=SelectButton.InternalOnKeyEvent
     End Object
     b_Select=GUIButton'W_TeamVoter.InterfaceTeamVoterPage.SelectButton'
     ...
     Begin Object Class=GUILabel Name=TestLabel
         ...
         bScaleToParent=True
     End Object
     l_Team=GUILabel'W_TeamVoter.InterfaceTeamVoterPage.TestLabel'
     ...
     Begin Object Class=GUILabel Name=TestLabelBlue
         ...
         bScaleToParent=True
     End Object
     l_BlueTeam=GUILabel'W_TeamVoter.InterfaceTeamVoterPage.TestLabelBlue'
     ...
     Begin Object Class=GUILabel Name=TestLabelRed
         ...
         bScaleToParent=True
     End Object
     l_RedTeam=GUILabel'W_TeamVoter.InterfaceTeamVoterPage.TestLabelRed'
     ...
     Begin Object Class=GUILabel Name=TestLabelMap
         ...
         bScaleToParent=True
     End Object
     l_MapName=GUILabel'W_TeamVoter.InterfaceTeamVoterPage.TestLabelMap'
     ...
     Begin Object Class=moEditBox Name=TestEditBoxSay
         ...
         WinWidth=0.700000
         WinHeight=0.040000
         OnKeyEvent=InterfaceTeamVoterPage.CheckMessage
     End Object
     eb_Say=moEditBox'W_TeamVoter.InterfaceTeamVoterPage.TestEditBoxSay'
